...
class Edit_Event_Popup extends Comcal_Featherlight_Event_Popup {
    ...
    public static function render_form( Comcal_Event $event = null ) : void {
        // TODO: move this to the Edit_Event_Form class.
          ...
          <form action="$admin_ajax_url" data-controller="form" method="post">
            <table>
              ...
              <tr>
                ...
                <td><input type="email" id="inputEmail" placeholder="max@mustermann.de"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>
              ...
              <tr>
                ...
                <td><input type="text" id="inputTitle" placeholder="Party im Hinterhof" maxlength="100"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td><input type="text" id="inputPlaceName" placeholder="Unser Hinterhof" maxlength="50"></td>
              </tr>
              <tr>
